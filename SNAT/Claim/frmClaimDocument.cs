...
{
    public partial class frmClaimDocument : Form
    {
        ...
        void FillDepartment()
        {
            try
            {
                string strSqlQuery = "SELECT id , code , name , status , mandatory , remarks FROM SNAT.dbo.M_ClaimDocType ORDER BY code";
        ...
        bool ValidateDelete()
        {
            ...
            try
            {
                ...
                if (ClsUtility.IsCodeValueExists("SNAT.dbo.T_ClaimDocuments", "doccode", "doccode", txtCode.Text.Trim()) == true)
                {
                    ...
                    if (ClsMessage.showAskDeleteMessage() == DialogResult.Yes)
                    {
                        ...
                        if (dtClaimDoc != null && dtClaimDoc.DefaultView.Count > 0)
                        {
                            if (dtClaimDoc.GetChanges() != null)
                            {
                                ...
                                bool lReturn = false;
                                strSqlQuery = "SELECT id , code , name , status , mandatory , remarks FROM SNAT.dbo.M_ClaimDocType where 1=2";
        ...
        private bool ValidateSave()
        {
            try
            {
                ...
                {
                    if (ClsUtility.IsCodeValueExists("SNAT.dbo.M_ClaimDocType", "code", "code", txtCode.Text.Trim()) == true)
                    {
                ...
                if (ClsUtility.FormMode == ClsUtility.enmFormMode.AddMode)
                {
                    if (ClsUtility.IsCodeValueExists("SNAT.dbo.M_ClaimDocType", "name", "name", txtName.Text.Trim()) == true)
                    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                frmsrch.infSqlSelectQuery = "SELECT id , code , name , status , mandatory , remarks FROM SNAT.dbo.M_ClaimDocType";
