...
namespace SNAT.CommanClass
{
    class clsSendSMS
    {
        public static bool SendSMSToMobileNo(string strMobileNo, string strMsg)
        {
            try
            {
                ...
                */
                string username = "santosh108";
                string password = "softtech123";
                /*
                * Your phone number, including country code, i.e. +44123123123 in this case:
                */
                //string msisdn = "26876495195";
                string msisdn = strMobileNo;
                ...
                */
                string seven_bit_msg = strMsg;//"Test message: all non-alphanumeric GSM characters: $@!#%&\",;:<>¡£¤¥§¿ÄÅÆÇÉÑÖØÜßàèéùìòå¿äöñüà\nGreek: ΩΘΔΦΓΛΩΠΨΣΘΞ";
                ...
                */
                string unicode_msg = strMsg;// "Unicode test message: ☺ \nArabic: شصض\nChinese: 本网";
                ...
                */
                string eight_bit_msg = strMsg;// "0605040B8423F0DC0601AE02056a0045c60d0362756c6b736d732e636f6d00010356697369742042756c6b534d532e636f6d20686f6d6570616765000101";
                ...
                */
                ...
                int num_retries = 5;
                string data = "";
                 data = seven_bit_message(username, password, msisdn, seven_bit_msg);
                ...
                for (int x = 0; x < num_retries; x++)
                {
                    ...
                    //{
                    //    ClsMessage.ProjectExceptionMessage(formatted_server_response(result));
                    //    break;
                    //}
                    //else
                    //{
                ...
                //    if ((int)result["success"] == 1)
                //    {
                //        System.Windows.Forms.MessageBox.Show(formatted_server_response(result));
                //        return true;
                //    }
                //    else
                //    {
        ...
        public static string Post(string url, string data)
        {
            ...
            try
            {
               ...
               // ClsMessage.ProjectExceptionMessage(WebResp.StatusCode.ToString());
